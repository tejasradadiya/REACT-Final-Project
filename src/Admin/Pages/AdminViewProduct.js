...
const AdminViewProduct = () => {
  ...
  const changeMarketStatus = (upid, value) => {
    axios
      .patch(`http://localhost:9000/products/${upid}`, {
        marketstatus: value,
      })
      .then(res => {
  ...
  return (
    <div>
      <div className='col-lg-12 p-4 pt-2'>
        <div
          style={{ boxShadow: '3px 3px 3px 3px #cccc' }}
          className='mt-4 p-5'
        >
                ...
                return (
                  <tr>
                    ...
                    <td>
                      {val.status === 'instock' ? (
                        <button
                          onClick={() => inStock(val.id, 'outstock')}
                        ...
                        <button
                          onClick={() => outStock(val.id, 'instock')}
        ...
        <button className='btn btn-primary mt-5'>
          <NavLink to={`/admin/product`} className='text-white'>
            Add Product
          </NavLink>
        </button>
      </div>
